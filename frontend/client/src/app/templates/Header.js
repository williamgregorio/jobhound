...
export default function Header() {
    ...
    // Use state to manage isAuthenticated
    ...
    const handleLogout = () => {
        ...
        // Update the state to reflect the change in authentication status
                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                        ...
                        >
                            ...
                            <g filter="url(#filter0_d_3_38)">
                                <rect
                                    ...
                                    height="44.2283"
                                    rx="5.30914"
                                    transform="rotate(150 35.3098 67.3969)"
                                    fill="#2978A0"
                                />
                            </g>
                            <g filter="url(#filter1_d_3_38)">
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    d="M47.9503 10.6651C50.5872 14.6115 51.9946 19.2511 51.9946 23.9973H42.6502C42.5931 16.0121 36.1022 9.55643 28.1035 9.55643C20.0694 9.55643 13.5564 16.0694 13.5564 24.1035C13.5564 32.1022 20.0121 38.5931 27.9973 38.6501V47.9946C23.2511 47.9946 18.6115 46.5872 14.6651 43.9504C10.7188 41.3135 7.643 37.5656 5.8267 33.1807C4.0104 28.7958 3.53517 23.9707 4.46111 19.3157C5.38705 14.6607 7.67258 10.3847 11.0287 7.02866C14.3847 3.67258 18.6607 1.38705 23.3157 0.461112C27.9707 -0.464829 32.7958 0.0103976 37.1807 1.8267C41.5656 3.643 45.3135 6.71879 47.9503 10.6651Z"
                                    fill="#0D2149"
                                />
                            </g>
                    ...
                    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
                        <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white light:bg-gray-800 md:light:bg-gray-900 light:border-gray-700">
                            ...
                            <li>
                                <Link href="dashboard" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-black dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Dasboard</Link>
                            </li>
                            <li>
                                <Link href="register" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-black dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Register</Link>
                            </li>
                        </ul>
                    </div>
                </div>
